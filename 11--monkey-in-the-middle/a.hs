...
main = do
  ...
  let monkeys = nthIteration 20 doRound initialMonkeys
...
doTurn n monkeys =
  ...
  in
    ...
    then monkeys
    else doTurn n $ doStep n monkeys
...
doStep n monkeys =
  let
    ...
    newWorryLevel = ((operation monkey) oldWorryLevel) `div` 3
